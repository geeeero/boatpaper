...
\centering
%\fbox{%
\includegraphics[trim = 86mm 48mm 94mm 62mm, clip, width=0.7\textwidth]{R/boatshape-domain}%
%}
...
(see, e.g., Figure~\ref{fig:boatshape-prior} below), hence its name.
...
as posterior inference reflecting uncertainty due to vague prior knowledge and stochasticity, will be shorter.
