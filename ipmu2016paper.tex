...
since the touchpoint moves further to the right when updating with strong-agreement data.
...
With the upper prior touchpoint being at $\ez$ coordinate ${\eta_0^u}\uz$,
the touchpoint movement to the right means that the upper posterior touchpoint $\ez$ coordinate ${\eta_0^u}\un$
is larger than the updated prior touchpoint coordinate,
