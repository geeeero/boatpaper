...
text(x=12, y=0, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
boat1$data <- list(tau = 8, n = 16)
boatplotter(boat1, prior=F, add=T)
text(x=20, y=0, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
boat1$data <- list(tau = 16, n = 16)
boatplotter(boat1, prior=F, add=T)
text(x=20, y=8, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
dev.off()
...
normalplotter(boat1, prior=F, xlims=c(2,25), addluck=T, usymmcred=0.5, usymmcredoffset=0.5)
text(x=14, y=0.8, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
normalplotter(boat1, add=T, addluck=T, usymmcred=0.5)
boat1$data <- list(tau = 4, n = 8)
normalplotter(boat1, prior=F, add=T, addluck=T, usymmcred=0.5)
text(x=14, y=0.5, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
boat1$data <- list(tau = 8, n = 16)
normalplotter(boat1, prior=F, add=T, addluck=T, usymmcred=0.5)
text(x=22, y=0.5, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
boat1$data <- list(tau = 16, n = 16)
normalplotter(boat1, prior=F, add=T, addluck=T, usymmcred=0.5, usymmcredoffset=0.5)
text(x=22, y=0.87, labels=bquote(paste("s = ", .(boat1$data$tau), ", n = ", .(boat1$data$n), sep="" )), cex=0.8)
dev.off()
