...
\author{Gero Walter, Frank P.A. Coolen and Mi\c{k}elis G. Bickis}{
 \fnms{Gero}
 \snm{Walter}
 \footnotemark[1]\ead{g.m.walter@tue.nl}
and
  \fnms{Frank P.A.}
  \snm{Coolen}
...
\footnotetext[1]{
 School of Industrial Engineering, TU Eindhoven, Eindhoven, NL,
 \href{mailto:g.m.walter@tue.nl}{g.m.walter@tue.nl}
}
\footnotetext[2]{
...
\includegraphics[height=\textwidth, angle=-90]{R/pppboat5.eps}

larger xp[1] and prior interval approx. [0,1] means large a and large b,
boat resembles anteater for large b:\\
\includegraphics[height=\textwidth, angle=-90]{R/pppboat6.eps}

two examples for $y_c \not = 0.5$ (focus on these, stronger pdc!)\\
\includegraphics[height=\textwidth, angle=-90]{R/pppboat7.eps}

\includegraphics[height=\textwidth, angle=-90]{R/pppboat8.eps}



\subsection{Posterior mode}

\includegraphics[height=\textwidth, angle=-90]{R/modeparams2.eps}

\includegraphics[height=\textwidth, angle=-90]{R/modeparams3.eps}
