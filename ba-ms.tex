...
\textbf{***imprecision to account for model uncertainty, Generalized Bayes' Rule, ***}
...
More precisely, \cite{Walter2009a-long} proposed
a direct extension of this model framework
...
and results in models that give more precise inferences when prior and data are in agreement.
